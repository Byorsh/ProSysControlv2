    ...
    <div class="full-box nav-lateral-content">
        <figure class="full-box nav-lateral-avatar">
            ...
            <figcaption class="roboto-medium text-center">
                Usuario <br><small class="roboto-condensed-light">Administrador</small>
            </figcaption>
        </figure>
        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <li>
                    <a href="#" class="nav-btn-submenu"><i class="fas fa-pallet fa-fw"></i> &nbsp; Catalogo <i class="fas fa-chevron-down"></i></a>
                    <ul>
                        <li>
                ...
                <li>
                    <a href="#" class="nav-btn-submenu"><i class="fas fa-file-invoice-dollar fa-fw"></i> &nbsp; Taller <i class="fas fa-chevron-down"></i></a>
                    <ul>
                        <li>
                            <a href="<?php echo SERVERURL; ?>reservation-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar equipo</a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL; ?>reservation-reservation/"><i class="far fa-calendar-alt fa-fw"></i> &nbsp; Servicio a domicilio</a>
                        </li>
                        <li>
